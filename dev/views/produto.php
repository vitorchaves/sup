  ...
  <div class="container heading-section">
    <div class="row">
      <div class="col-md-8 offset-md-2 text-center">
        <h1>Transforme sua loja em <span class="text-main">uma experiência de compra unificada</span> </h1>
      </div>
    </div>
    <div class="row mt-5">
      <div class="col-md-10 offset-md-1 text-center">
        <img src="img/telas-produto.svg" alt="Imagem mostrando várias telas e elementos do sistema." title="Telas do Produto" class="img-fluid">
      </div>
    </div>
  </div>
</section>
...
<section id="fullControl" class="my-80 py-60 bg-secColor">
  <div class="container">
    <div class="row mb-3">
      <div class="col-md-6 offset-md-3">
        <h2 class="text-white section-title text-center">Total controle do seu negócio</h2>
      </div>
    </div>
...
<section id="vantagens" class="virtualMarket my-80">
  <div class="container">
    <div class="row text-center">
      <div class="col-md-6 offset-md-3">
        <h2 class="section-title mb-5">Acelere seu negócio com as melhores funcionalidades do mercado</h2>
      </div>
    </div>
    <div class="row justify-center">
      <div class="col-md-4 info-group">
