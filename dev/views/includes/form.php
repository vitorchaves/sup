      ...
      <div class="row">
        <div class="col-md-6 form-group">
          <select id="faturamento" class="form-control">
            ...
            <option value="0">De 21 a 50 Milhões</option>
            <option value="0">De 51 a 100 Milhões</option>
            <option value="0">De 101 Milhões a 1 Bilhão</option>
            <option value="0">Acima de 1 Bilhão</option>
          </select>
        </div>
